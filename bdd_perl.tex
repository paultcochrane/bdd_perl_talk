...
\begin{itemize}
    ...
    \item More info from \url{www.cukes.info}
\end{itemize}
...
\begin{itemize}
    \item Now add next scenario
\end{itemize}

\begin{lstlisting}
    Scenario: a list of names
        Given the list of names "bob", "alice", "charlie", "eve"
        When I say moin
        Then I should see "moin bob", "moin alice", "moin charlie", "moin eve"
\end{lstlisting}
...
tags, background, tables, pystrings
